...
export type OrderProductWhereInput = {
  ...
  unitPrice?: Prisma.DecimalFilter<"OrderProduct"> | runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type OrderProductScalarWhereWithAggregatesInput = {
  ...
  unitPrice?: Prisma.DecimalWithAggregatesFilter<"OrderProduct"> | runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type OrderProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"quantity" | "unitPrice" | "createdAt" | "orderId" | "productId", ExtArgs["result"]["orderProduct"]>
...
export interface OrderProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const orderProductWithQuantityOnly = await prisma.orderProduct.findMany({ select: { quantity: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrderProducts and only return the `quantity`
   * const orderProductWithQuantityOnly = await prisma.orderProduct.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more OrderProducts and only return the `quantity`
   * const orderProductWithQuantityOnly = await prisma.orderProduct.updateManyAndReturn({
   *   select: { quantity: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrderProductFieldRefs {
  ...
  readonly unitPrice: Prisma.FieldRef<"OrderProduct", 'Decimal'>
